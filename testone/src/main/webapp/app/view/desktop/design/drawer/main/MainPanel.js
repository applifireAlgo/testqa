Ext.define('Testone.view.desktop.design.drawer.main.MainPanel', {
    extend : 'Ext.panel.Panel',
    xtype : 'mainPanel',
    requires : ['Testone.view.desktop.design.drawer.main.MainPanelController','Testone.view.desktop.design.drawer.resource.AppFormsList'],
    userinfo:{},
    id:'mainPanel',
